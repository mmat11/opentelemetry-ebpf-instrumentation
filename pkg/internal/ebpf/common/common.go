...
type (
	...
	MySQLRequestEvent   bpfMysqlRequestEventT
	MySQLResponseEvent  bpfMysqlResponseEventT
)
...
const (
	...
	EventTypeMySQLRequest  = 12 // MySQL client (TCP)
	EventTypeMySQLResponse = 13 // MySQL client (TCP)
)
...
func ReadBPFTraceAsSpan(cfg *config.EBPFTracer, record *ringbuf.Record, filter ServiceFilter) (request.Span, bool, error) {
	...
	case EventTypeMySQLRequest, EventTypeMySQLResponse:
		return ReadMySQLEventIntoSpan(eventType, record)
	}
